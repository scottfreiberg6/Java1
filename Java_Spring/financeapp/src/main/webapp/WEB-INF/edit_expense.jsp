    ...
    <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
      <%@taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
        <%@ page isErrorPage="true" %>
          ...
          <body>
            <div class="container">
            <h1 class="teal-text">Update a Expense</h1>
              <nav>
                <div class="nav-wrapper teal accent-4">
              	...
              	<form:form class="col s12" action="/expense/${id}/edit" method="POST" modelAttribute="expense">
              	<div class="row">
              	<div class="input-field col s6">
					...
					<div class="input-field col s6">
					<form:errors path="category" class="red-text"></form:errors>
					<form:input path="category" placeholder="category"></form:input>
					<form:hidden path="user" value="${user.id}"/>
              		</div>
              		</div>
              		 <input type="submit" value="Update" class="btn waves-effect waves-light teal accent-4">
              	</form:form>
              	</div>
          </body>
